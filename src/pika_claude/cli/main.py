...
from pika_claude.cli.commands.chat import cmd_chat
from pika_claude.cli.commands.core import cmd_core_start, cmd_core_status, cmd_core_stop
from pika_claude.cli.commands.ping import cmd_ping
from pika_claude.cli.commands.run import cmd_run
from pika_claude.cli.commands.trace import cmd_trace
from pika_claude.cli.commands.version import cmd_version
from pika_claude.core.config import get_config
from pika_claude.core.logging_setup import setup_logging


# CLI 主入口：解析命令行参数并分发到对应子命令
def main() -> None:
    parser = argparse.ArgumentParser(prog="pika", description="PikaClaude CLI")
