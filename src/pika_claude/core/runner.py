...
from pika_claude.core.bus.events import RunFinishedEvent, RunStartedEvent
...
from pika_claude.core.events.bus import EventBus, EventHandler
from pika_claude.core.events.writer import EventWriter
from pika_claude.core.llm.base import LLMProvider
from pika_claude.core.llm.provider import AnthropicProvider
from pika_claude.core.loop import AgentLoop
from pika_claude.core.mcp.server import McpServerManager
from pika_claude.core.memory.loader import load_context_file
from pika_claude.core.permissions.manager import PermissionManager
from pika_claude.core.runs import RUNS_DIR, new_run_id
from pika_claude.core.session.model import Session
from pika_claude.core.session.store import SessionStore
from pika_claude.core.subagent.registry import BackgroundTaskRegistry
from pika_claude.core.subagent.tool import AgentResultTool, SpawnAgentTool
from pika_claude.core.task.manager import TaskManager
from pika_claude.core.tools.builtin import (
    BashTool,
    ListDirTool,
    NoteSaveTool,
    ReadFileTool,
...
from pika_claude.core.trace.provider import TracingProvider
...
class AgentRunner:
    ...
    async def run_and_capture(
        ...
        *,
        ...
        global_ctx = load_context_file(Path("~/.pika/context.md").expanduser())
        project_ctx = load_context_file(Path(".pika/context.md"))
