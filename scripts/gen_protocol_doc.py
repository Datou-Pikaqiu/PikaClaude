#!/usr/bin/env python3
"""Generate WIRE_PROTOCOL.md from pydantic models in pika_claude.core.bus."""
...
def generate() -> str:
    ...
    sections = [
        ...
        "## Transport\n\n",
        "- TCP loopback `127.0.0.1:7437` (override via `PIKA_HOST` / `PIKA_PORT`)\n",
        ...
        _model_section("LogLineEvent", LogLineEvent,
            {"type": "log.line", "run_id": run_id, "level": "INFO",
             "source": "pika_claude.core.loop", "message": "step 1 started", "ts": ts}),
        "\n## Session Events\n\n",
